...
#define CUSTOM_MACHINE_NAME "P3Steel 3DE"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {160,160,8000,185}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {300, 300, 3, 25}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {1000,1000,35,10000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
